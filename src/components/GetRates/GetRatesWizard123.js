                      ...
                      <table>
                        <thead>
                          <tr>
                            ...
                            <th>{this.state.finalOceanResult[0].col0.label}</th>
                            <th>{this.state.finalOceanResult[0].col1.label}</th>
                            <th>{this.state.finalOceanResult[0].col2.label}</th>
                          </tr>
                        </thead>
                        <tbody>
                      ...
                      <table>
                        <thead>
                          <tr>
                            ...
                            {this.state.finalOceanResult[0].col2 != undefined ? (
