          ...
          <Card className="z-index-9">
            ...
            <CardBody>
                ...
                <GridItem xs={12} sm={12} md={3}>
                  <FormControl fullWidth>
                    <Autocomplete
                      {...referredby}
                      id="referredby"
                      // error={this.state.referredyErr}
                      // helperText={this.state.referredbyHelperText}
                    ...
                    <span
                      ...
                      style={{ color: "red", fontSize: "12px" }}
                    >
                      {!this.state.ReferredBy ? "Please select any one" : null}
                    </span>
                    {/* ) : null} */}
                  </FormControl>
                </GridItem>
              ...
              <GridContainer justify="center">
                ...
                <GridItem xs={12} sm={12} md={3}>
                  <div className="date-input with-icon">
                    ...
                    <span
                      ...
                      style={{ color: "red", fontSize: "12px" }}
                    >
                      {!this.state.StartDate ? "Please select any one" : null}
                    </span>
                  </div>
                </GridItem>
                ...
                <GridItem xs={12} sm={12} md={3}>
                  <div className="date-input">
                    <InputLabel className={classes.label}>Lead From</InputLabel>
                    {this.state.newurl && this.state.newurl !== "NULL" ? (
                      <Tooltip title={this.state.newurl} arrow>
                        <Button
                          className="Plus-btn info-icon"
